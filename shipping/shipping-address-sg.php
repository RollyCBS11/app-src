...
<div class="mb-3">
    <label class="p cart-input-label" for="address 1" label="Street, house and apartment number"><?= $collector_sh->translate("address_1_".$country, "Street, house and apartment number") ?></label>
    <div>
        <input id="fields_address1" name="address 1" class="cart-input p" value="" type="text" placeholder="<?= $collector_sh->translate("p_address_1_".$country, "Street, house and apartment number") ?>" required="required">
    </div>
</div>
...
<div class="mb-3 d-none">
    ...
    <div>
        <input id="fields_city" name="city" class="cart-input p" value="Singapore" type="text" required="required">
    </div>
</div>
...
<div class="row align-items-start">
    <div class="col-sm-12">
        <div class="row mb-n3 align-items-start">
            ...
            <div class="col-sm-12">
                <div class="mb-3">
                    <label class="p cart-input-label" for="zip" label="Zip/Postal Code"><?= $collector_sh->translate("zip_".$country, "Postal Code"); ?></label>
                    <div>
                        <input id="fields_zip" name="zip" class="cart-input p" value="" type="text" placeholder="<?= $collector_sh->translate("p_zip_".$country, "Postal Code"); ?>" required="required">
                    </div>
                </div>
            </div>
        </div>       
